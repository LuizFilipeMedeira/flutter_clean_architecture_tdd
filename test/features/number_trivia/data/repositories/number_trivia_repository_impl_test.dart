...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      ...
      test(
          'should cache the data locally data when the call to remote data source is success',
          () async {
        //arrange
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
            .thenAnswer((_) async => tNumberTriviaModel);
    ...
    runTestsOffline(() {
      ...
      test('should return CacheFailure there is no cached data present',
          () async {
        //arrange
        when(mockLocalDataSource.getLastNumberTrivia())
  ...
  group('getRandomNumberTrivia', () {
    ...
    runTestsOnline(() {
      ...
      test(
          'should cache the data locally data when the call to remote data source is successful',
              () async {
            //arrange
            when(mockRemoteDataSource.getRandomNumberTrivia())
                .thenAnswer((_) async => tNumberTriviaModel);
